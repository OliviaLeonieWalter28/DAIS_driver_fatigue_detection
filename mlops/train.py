...
@app.command()
def train_model(
    participant: Annotated[int,typer.Option(help="number of the chosen participant.")] = None,
    ...
    # Dataset
    ds = data.load_data(dataset_loc=dataset_loc, subset='train', participant=participant, num_samples=train_loop_config["num_samples"])

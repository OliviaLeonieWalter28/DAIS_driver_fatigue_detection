...
# search for Ubuntu in your searchbar
sudo apt install git
git clone #enter githubs url here
cd driver_fatigue_detection
code .
```

#pre-steps (in terminal in vs-code)
```
...
Choose a participant from the preprocessed_dataset/train folder (ex. 28_5.csv stands for participant 28)
and change the value for the chosen one in the --participant_test flag below
Change username in DATASET_LOC and OUTPUT_LOC to your ubuntu username (OBS. you might need to create output folder)
```
export DATASET_LOC="/home/username/preprocessed_dataset/train"
...
# Training
change the value of participant below to the one you chose
```
...
```
export EXPERIMENT_NAME="fatigue_with_CV"
export RUN_ID = "ea228a827c814bb7bf49d93ec6890c43"
...
Follow preprocessing step first then change --particpant flag to the one you chose
